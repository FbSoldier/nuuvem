...
<div class="container">
    <form class="row g-3" Method="Post" action="{{route('alterarBanco-contato',$contatos->id)}}">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" value="{{$contatos->emailContato}}" name='emailContato' id="inputEmail">
        </div>

        <div class="col-md-4">
            <label for="cepContato" class="form-label">Cep</label>
            <input type="text" class="form-control" value="{{$contatos->cepContato}}" name='cepContato' id="inputCep">
        </div>
